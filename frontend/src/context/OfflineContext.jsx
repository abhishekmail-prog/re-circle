        ...
        try {
          ...
          if (action.type === 'CREATE_LOT') {
            ...
            if (offlinePhotos.length > 0) {
              // Photos are already base64 data URLs — send them straight to /lots.
              // No round-trip through /ai/classify needed.
              console.log('[SYNC] using', offlinePhotos.length, 'queued data URL(s) directly')
              cleanBody.imageUrl = offlinePhotos[0]
              cleanBody.imageUrls = offlinePhotos
            }
